...
@Component({
  selector: 'app-reportadvanceallocation',
  templateUrl: './reportadvanceallocation.component.html'
})
export class ReportAdvanceAllocation extends BaseComponent implements OnInit {
  // get param from url
  ...
  //lookup Agreement No
  private APIControllerAgreementMain = 'AgreementMain';
  private APIRouteForLookupAgreement= 'GetRowsForLookupReportAgree';
  ...
  btnLookupAgreementNo() {
    ...
    $('#datatableLookupAgreementNo').DataTable({
      ...
      columnDefs: [{ orderable: false, searchable: false, width: '5%', targets: [0, 1, 4] }], // for disabled coloumn
      language: {
        search: '_INPUT_',
  ...
  btnSelectRowAgreementNo(code: String, name: String) {
