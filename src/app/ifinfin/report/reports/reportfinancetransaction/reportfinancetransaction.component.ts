...
@Component({
  selector: 'app-reportfinancetransaction',
  templateUrl: './reportfinancetransaction.component.html'
})
export class ReportFinanceTransaction extends BaseComponent implements OnInit {
  // get param from url
  ...
  //lookup Gl Link
  private APIControllerGlLink = 'JournalGlLink';
  private APIRouteForLookupGlLink = 'GetRowsForLookupReport';
  private APIRouteForLookupBank = 'GetRowsForLookupReportBankFinanceTransaction';
  ...
  ngOnInit() {
    ...
    this.model.type = 'PAYMENT VOUCHER';
  ...
  //       });
  //       // end param tambahan untuk getrows dynamic
  //       this.dalservice.Getrows(dtParameters, this.APIControllerGlLink, this.APIRouteForLookupGlLink).subscribe(resp => {
  //         const parse = JSON.parse(resp);
  ...
  btnLookupBank() {
    ...
    $('#datatableLookupBank').DataTable({
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        // end param tambahan untuk getrows dynamic
        this.dalservice.Getrows(dtParameters, this.APIControllerGlLink, this.APIRouteForLookupBank).subscribe(resp => {
          const parse = JSON.parse(resp);
