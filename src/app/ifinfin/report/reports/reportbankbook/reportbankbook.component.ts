...
@Component({
  selector: 'app-reportbankbook',
  templateUrl: './reportbankbook.component.html'
})
export class ReportBankBook extends BaseComponent implements OnInit {
  // get param from url
  ...
  public lookupbankno: any = [];
  public type: String;
  public branch_code: String;
  public saldo_awal: any = [];
  public dataTamp: any = [];
  ...
  //lookup Bank No
  private APIControllerBankNo = 'BankMutation';
  private APIRouteForLookupBankNo = 'GetRowsForLookupReportBank';
  ...
  ngOnInit() {
    ...
    this.model.type = 'TRANSACTION';
    this.model.print_option = 'Excel';
    this.callGetrow();
    // this.model.saldo_awal = '0';
  }
  ...
  //#region Bank No Lookup
  btnLookupBankNo() {
    $('#datatableLookupBankNo').DataTable().clear().destroy();
    $('#datatableLookupBankNo').DataTable({
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIControllerBankNo, this.APIRouteForLookupBankNo).subscribe(resp => {
          const parse = JSON.parse(resp);
          this.lookupbankno = parse.data;
          if (parse.data != null) {
            this.lookupbankno.numberIndex = dtParameters.start;
          }
          callback({
            draw: parse.draw,
  ...
  btnSelectRowBankNo(branch_bank_code: String, branch_bank_name: String) {
    this.model.branch_bank_code = branch_bank_code;
    this.model.branch_bank_name = branch_bank_name;
    $('#lookupModalBankNo').modal('hide');
  }
  //#endregion Bank No lookup
