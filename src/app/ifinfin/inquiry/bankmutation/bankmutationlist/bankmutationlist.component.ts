...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './bankmutationlist.component.html'
})

export class BankmutationlistComponent extends BaseComponent implements OnInit {
  // variable
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listinquiry = parse.data;
          if (parse.data != null) {
            this.listinquiry.numberIndex = dtParameters.start;
          }
  ...
  btnEdit(codeEdit: string) {
    this.route.navigate(['/inquiry/subbankmutationlist/bankmutationdetail', codeEdit]);
  }
  ...
  btnSelectRowBranchcode(branch_code: String, branch_name: String) {
    ...
    $('#datatableBankMutationList').DataTable().ajax.reload();
  }
