...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './rvmanuallist.component.html'
})

export class RvmanuallistComponent extends BaseComponent implements OnInit {
  // variable
  public listrvmanual: any = [];
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listrvmanual = parse.data;
          if (parse.data != null) {
            this.listrvmanual.numberIndex = dtParameters.start;
          }
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/pvorrvrequest/subrvmanuallist/rvmanualdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/pvorrvrequest/subrvmanuallist/rvmanualdetail', codeEdit]);
  }
