...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './pvmanuallist.component.html'
})

export class PvmanuallistComponent extends BaseComponent implements OnInit {
  // variable
  public listpvmanual: any = [];
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listpvmanual = parse.data;
          if (parse.data != null) {
            this.listpvmanual.numberIndex = dtParameters.start;
          }
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/pvorrvrequest/subpvmanuallist/pvmanualdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/pvorrvrequest/subpvmanuallist/pvmanualdetail', codeEdit]);
  }
