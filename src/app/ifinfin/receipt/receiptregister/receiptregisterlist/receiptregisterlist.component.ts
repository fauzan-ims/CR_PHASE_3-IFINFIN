...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './receiptregisterlist.component.html'
})

export class ReceiptregisterlistComponent extends BaseComponent implements OnInit {
  // variable
  public listreceiptregister: any = [];
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listreceiptregister = parse.data;
          if (parse.data != null) {
            this.listreceiptregister.numberIndex = dtParameters.start;
          }
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/receipt/subreceiptregisterlist/receiptregisterdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/receipt/subreceiptregisterlist/receiptregisterdetail', codeEdit]);
  }
