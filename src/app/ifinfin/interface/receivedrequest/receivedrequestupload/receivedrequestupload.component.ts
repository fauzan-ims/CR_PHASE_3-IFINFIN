...
@Component({
    selector: 'app-receivedrequestupload',
    templateUrl: './receivedrequestupload.component.html'
})

export class ReceivedRequestuploadComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    // variable
    public listReceivedRequestUpload: any = [];
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForUploadGetRows).subscribe(resp => {
                    ...
                    this.listReceivedRequestUpload = parse.data;
                    if (parse.data != null) {
                        this.listReceivedRequestUpload.numberIndex = dtParameters.start;
                    }
                    ...
                    .subscribe(
                        res => {
                            ...
                            if (parse.result === 1) {
                                ...
                                this.route.navigate(['/interface/subreceivedrequestlist']);
                            } else {
                                this.swalPopUpMsg(parse.data);
                            }
                        },
                    ...
                    .subscribe(
                        res => {
                            ...
                            if (parse.result === 1) {
                                ...
                                //$('#datatablesReceivedRequestUpload').DataTable().ajax.reload();
