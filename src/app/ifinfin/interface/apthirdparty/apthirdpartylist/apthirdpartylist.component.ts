...
@Component({
  selector: 'app-apthirdpartylist',
  templateUrl: './apthirdpartylist.component.html'
})

export class ApThirdPartylistComponent extends BaseComponent implements OnInit {
  // get param from url
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listApThirdParty = parse.data;

          if (parse.data != null) {
            this.listApThirdParty.numberIndex = dtParameters.start;
          }
  ...
  btnEdit(codeEdit: string) {
    this.route.navigate(['/interface/subapthirdpartylist/apthirdpartydetail', codeEdit]);
  }
  ...
  btnSelectRowLookupBranch(branch_code: String, branch_name: String) {
    ...
    $('#datatableAoThirdPartyList').DataTable().ajax.reload();
  }
