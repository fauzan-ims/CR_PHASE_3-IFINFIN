...
@Component({
    selector: 'app-cashierreceivedrequestupload',
    templateUrl: './cashierreceivedrequestupload.component.html'
})

export class CashierReceivedRequestuploadComponent extends BaseComponent implements OnInit {
    // get param from url
    ...
    // variable
    public listCashierReceivedRequestUpload: any = [];
        ...
        this.dtOptions = {
            ...
            ajax: (dtParameters: any, callback) => {
                ...
                this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForUploadGetRows).subscribe(resp => {
                    ...
                    this.listCashierReceivedRequestUpload = parse.data;
                    if (parse.data != null) {
                        this.listCashierReceivedRequestUpload.numberIndex = dtParameters.start;
                    }
                    ...
                    .subscribe(
                        res => {
                            ...
                            if (parse.result === 1) {
                                ...
                                //$('#datatableCashierReceivedRequestUpload').DataTable().ajax.reload();
