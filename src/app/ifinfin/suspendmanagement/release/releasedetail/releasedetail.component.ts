...
export class ReleasedetailComponent extends BaseComponent implements OnInit {
      ...
      this.dalservice.Insert(usersJson, this.APIController, this.APIRouteForInsert)
        .subscribe(
          res => {
            ...
            if (parse.result === 1) {
              this.showNotification('bottom', 'right', 'success');
              this.route.navigate(['/suspendmanagement/subreleaselist/releasedetail', parse.code]);
            } else {
              this.swalPopUpMsg(parse.data);
            }
          },
  ...
  //#region button back
  btnBack() {
    this.route.navigate(['/suspendmanagement/subreleaselist']);
  ...
  btnSelectRowSysBranch(branch_code: String, branch_name: String) {
    ...
    this.model.suspend_currency_code = '';
  ...
  btnSelectRowSuspend(suspend_code: String, suspend_currency_code: string, suspend_amount: string) {
    this.model.suspend_code = suspend_code;
    this.model.suspend_currency_code = suspend_currency_code;
