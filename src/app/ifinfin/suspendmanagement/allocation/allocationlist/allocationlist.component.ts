...
export class AllocationlistComponent extends BaseComponent implements OnInit {
  // variable
  public listallocation: any = [];
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp.push({
          ...
          'p_allocation_status': this.tampStatus
        });
        // end param tambahan untuk getrows dynamic
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          const parse = JSON.parse(resp)
          this.listallocation = parse.data;
          if (parse.data != null) {
            this.listallocation.numberIndex = dtParameters.start;
          }
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/suspendmanagement/suballocationlist/allocationdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/suspendmanagement/suballocationlist/allocationdetail', codeEdit]);
  }
