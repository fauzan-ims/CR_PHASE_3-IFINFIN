...
export class InquirydetailComponent extends BaseComponent implements OnInit {
  ...
  private RoleAccessCode = 'R00003320000000A';


  private APIController: String = 'SuspendMain';
  private APIControllerSuspendHistory: String = 'SuspendHistory';
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        dtParameters.paramTamp.push({
          'p_suspend_code': this.param,
        });
        // end param tambahan untuk getrows dynamic
        this.dalservice.Getrows(dtParameters, this.APIControllerSuspendHistory, this.APIRouteForGetRows).subscribe(resp => {
  ...
  //#region button back
  btnBack() {
    this.route.navigate(['/suspendmanagement/subinquirylist']);
