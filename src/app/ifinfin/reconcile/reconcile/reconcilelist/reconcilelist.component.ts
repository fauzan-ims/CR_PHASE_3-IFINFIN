...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './reconcilelist.component.html'
})

export class ReconcilelistComponent extends BaseComponent implements OnInit {
  // variable
  public listreconcile: any = [];
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        paramTamps = {
          ...
          'p_reconcile_status': this.tampStatus,
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listreconcile = parse.data;

          if (parse.data != null) {
            this.listreconcile.numberIndex = dtParameters.start;
          }
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/reconcile/subreconcilelist/reconciledetail']);
  }
  //#endregion button add

  //#region button edit                                                
  btnEdit(codeEdit: string) {
    this.route.navigate(['/reconcile/subreconcilelist/reconciledetail', codeEdit]);
  }
