...
export class AllocationlistComponent extends BaseComponent implements OnInit {
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/depositmanagement/suballocationlist/allocationdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/depositmanagement/suballocationlist/allocationdetail', codeEdit]);
  }
