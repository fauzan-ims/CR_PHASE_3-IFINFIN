...
export class InquirylistComponent extends BaseComponent implements OnInit {
  ...
  private APIRouteForGetRows: String = 'GetRowsFinance';
  ...
  loadData() {
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.GetrowsOpl(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
  ...
  btnEdit(codeEdit: string) {
    this.route.navigate(['/depositmanagement/subinquirylist/inquirydetail', codeEdit]);
  }
