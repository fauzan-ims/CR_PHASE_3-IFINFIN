...
export class AccounttransferrequestlistComponent extends BaseComponent implements OnInit {
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/cashier/subaccounttransferrequestlist/accounttransferrequestdetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/cashier/subaccounttransferrequestlist/accounttransferrequestdetail', codeEdit]);
  }
