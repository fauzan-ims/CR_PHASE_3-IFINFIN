...
@Component({
  moduleId: module.id,
  selector: 'app-root',
  templateUrl: './cashieropenlist.component.html'
})

export class CashieropenlistComponent extends BaseComponent implements OnInit {
  // variable
  public listcashieropen: any = [];
    ...
    this.dtOptions = {
      ...
      ajax: (dtParameters: any, callback) => {
        ...
        this.dalservice.Getrows(dtParameters, this.APIController, this.APIRouteForGetRows).subscribe(resp => {
          ...
          this.listcashieropen = parse.data;
          if (parse.data != null) {
            this.listcashieropen.numberIndex = dtParameters.start;
          }
  ...
  //#region button add
  btnAdd() {
    this.route.navigate(['/cashier/subcashieropenlist/cashieropendetail']);
  }
  //#endregion button add

  //#region button edit
  btnEdit(codeEdit: string) {
    this.route.navigate(['/cashier/subcashieropenlist/cashieropendetail', codeEdit]);
  }
